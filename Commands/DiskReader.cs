...
namespace msp.Commands
{
    public class DiskReader
    {
        ...
        private string selectedDestinationDisk;
        ...
        public DiskReader(string selectedDestinationDisk)
        {
            this.selectedDestinationDisk = selectedDestinationDisk;
        }
